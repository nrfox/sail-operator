...
func ComputeValues(
	...
	activeRevisionName string, tlsSettings *istiovalues.TLSSettings,
) (*v1.Values, error) {
	...
	// apply OpenShift TLS settings from APIServer before FIPS values
	mergedHelmValues, err = istiovalues.ApplyAPIServerTLSSettings(tlsSettings, mergedHelmValues)
	if err != nil {
